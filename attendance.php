          ...
          <div class="form-group" id="student_details">
            <div class="table-responsive">
              <table class="table table-striped table-bordered">
                ...
                foreach($student_result as $Employee)
                {
                ?>
                  <tr>
                    <td><?php echo $Employee["student_roll_number"]; ?></td>
                    <td>
                      <?php echo $Employee["student_name"]; ?>
                      <input type="hidden" name="student_id[]" value="<?php echo $Employee["student_id"]; ?>" />
                    </td>
                    <td>
                      <input type="radio" name="attendance_status<?php echo $Employee["student_id"]; ?>" value="Present" />
                    </td>
                    <td>
                      <input type="radio" name="attendance_status<?php echo $Employee["student_id"]; ?>" checked value="Absent" />
                    </td>
                  </tr>
                <?php
                }
